...
namespace CleanArchitecture.Course.Project.Infrastructure.Migrations
{
    ...
    [Migration("20240810205113_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Alquileres.Alquiler", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Vehiculos.Vehiculo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Alquileres.Alquiler", b =>
                {
                    b.HasOne("CleanArchitecture.Course.Project.Domain.Entities.Users.User", null)
                        .WithMany()
                    ...
                    b.HasOne("CleanArchitecture.Course.Project.Domain.Entities.Vehiculos.Vehiculo", null)
                        .WithMany()
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Shared.Moneda", "PrecioAccesorios", b1 =>
                        {
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Shared.Moneda", "PrecioMantenimiento", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Shared.Moneda", "PrecioPeriodo", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<decimal>("Monto")
                                .HasColumnType("numeric")
                                .HasColumnName("precio_periodo_monto");

                            b1.Property<string>("TipoMoneda")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("precio_periodo_tipo_moneda");
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Shared.Moneda", "PrecioTotal", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Alquileres.DateRange", "Duracion", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Reviews.Review", b =>
                {
                    b.HasOne("CleanArchitecture.Course.Project.Domain.Entities.Alquileres.Alquiler", null)
                        .WithMany()
                        .HasForeignKey("AlquilerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("CleanArchitecture.Course.Project.Domain.Entities.Vehiculos.Vehiculo", b =>
                {
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Vehiculos.Direccion", "Direccion", b1 =>
                        {
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Shared.Moneda", "Mantenimiento", b1 =>
                        {
                            b1.Property<Guid>("VehiculoId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("CleanArchitecture.Course.Project.Domain.Entities.Shared.Moneda", "Precio", b1 =>
                        {
                            b1.Property<Guid>("VehiculoId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
