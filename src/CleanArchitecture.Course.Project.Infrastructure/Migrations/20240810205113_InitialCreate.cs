...
namespace CleanArchitecture.Course.Project.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    precio_periodo_monto = table.Column<decimal>(type: "numeric", nullable: true),
                    precio_periodo_tipo_moneda = table.Column<string>(type: "text", nullable: true),
                    ...
                    fecha_rechazo = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
